      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {committeeFeatures.map((feature, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden card-hover transition-all duration-300">
              <div className={`${feature.color} p-4 text-white transition-colors duration-300`}>
                <feature.icon className="h-8 w-8 mb-2" />
                <h3 className="font-semibold text-lg">{feature.title}</h3>
              </div>
              <div className="p-6">
                <p className="text-gray-600 dark:text-gray-400 mb-4 transition-colors duration-300">{feature.description}</p>
                <AppButton 
                  fullWidth
                  className="interactive-element hover:shadow-lg"
                >
                  {feature.action}
                </AppButton>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg transition-colors duration-300 card-hover">
              <h3 className="font-medium text-green-800 dark:text-green-200 transition-colors duration-300">
                Ingresos del Mes
              </h3>
            ...
            <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg transition-colors duration-300 card-hover">
              <h3 className="font-medium text-red-800 dark:text-red-200 transition-colors duration-300">
                Gastos del Mes
              </h3>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg transition-colors duration-300 card-hover">
              <h3 className="font-medium text-blue-800 dark:text-blue-200 transition-colors duration-300">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg transition-colors duration-300 card-hover">
              <h3 className="font-medium text-yellow-800 dark:text-yellow-200 transition-colors duration-300">
                Próxima Reunión
              </h3>
              <p className="text-sm font-semibold text-yellow-600 dark:text-yellow-400 transition-colors duration-300">
                15 Enero 2024
              </p>
            </div>
          </div>
